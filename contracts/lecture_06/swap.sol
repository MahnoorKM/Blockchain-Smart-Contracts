...
contract TokenA is ERC20 {
    constructor(address recipient) ERC20("TokenA", "MTK") {
        _mint(recipient, 100000000 * 10 ** decimals());
    }
}

contract TokenB is ERC20 {
    constructor(address recipient) ERC20("TokenB", "MTK") {
        _mint(recipient, 100000000 * 10 ** decimals());
    }
}
// implement a function in which only the owner can change the rate
// 
